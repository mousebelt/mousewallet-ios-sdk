...
public struct AllowTrustOperationXDR: XDRCodable {
    public var trustor: StellarPublicKey
    public var asset: AllowTrustOpAssetXDR
    public var authorize:Bool
    
    public init(trustor: StellarPublicKey, asset:AllowTrustOpAssetXDR, authorize:Bool) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        trustor = try container.decode(StellarPublicKey.self)
