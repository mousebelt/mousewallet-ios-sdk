...
public struct ClaimOfferAtomXDR: XDRCodable {
    public let sellerId: StellarPublicKey
    ...
    public init(sellerId: StellarPublicKey, offerId:Int64, assetSold: AssetXDR, amountSold:Int64, assetBought: AssetXDR, amountBought:Int64) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        sellerId = try container.decode(StellarPublicKey.self)
