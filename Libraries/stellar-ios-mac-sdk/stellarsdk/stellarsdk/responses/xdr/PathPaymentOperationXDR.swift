...
public struct PathPaymentOperationXDR: XDRCodable {
    ...
    public let destinationID: StellarPublicKey
    public let destinationAsset: AssetXDR
    public let destinationAmount: Int64
    public let path: [AssetXDR]
    
    init(sendAsset: AssetXDR, sendMax: Int64, destinationID: StellarPublicKey, destinationAsset: AssetXDR, destinationAmount:Int64, path:[AssetXDR]) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        destinationID = try container.decode(StellarPublicKey.self)
