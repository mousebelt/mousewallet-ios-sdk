...
public struct SetOptionsOperationXDR: XDRCodable {
    public var inflationDestination: StellarPublicKey?
    ...
    public init(from decoder: Decoder) throws {
        ...
        inflationDestination = try decodeArray(type: StellarPublicKey.self, dec: decoder).first
    ...
    public init(inflationDestination: StellarPublicKey?, clearFlags:UInt32?, setFlags:UInt32?, masterWeight:UInt32?, lowThreshold:UInt32?, medThreshold:UInt32?, highThreshold:UInt32?, homeDomain:String?, signer:SignerXDR?) {
