...
public struct TransactionXDR: XDRCodable {
    public let sourceAccount: StellarPublicKey
    ...
    public init(sourceAccount: StellarPublicKey, seqNum: UInt64, timeBounds: TimeBoundsXDR?, memo: MemoXDR, operations: [OperationXDR]) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        sourceAccount = try container.decode(StellarPublicKey.self)
    ...
    public mutating func sign(keyPair:StellarKeyPair, network:Network) throws {
