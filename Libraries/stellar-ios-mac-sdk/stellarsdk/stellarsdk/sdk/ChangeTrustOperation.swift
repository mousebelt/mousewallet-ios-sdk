...
public class ChangeTrustOperation:Operation {
    ...
    ///
    public init(sourceAccount:StellarKeyPair? = nil, asset:StellarAsset, limit:Decimal) {
        self.asset = asset
        self.limit = limit
    ...
    ///
    public init(fromXDR:ChangeTrustOperationXDR, sourceAccount:StellarKeyPair? = nil) {
