...
public class CreateAccountOperation:Operation {
    ...
    ///
    public init(sourceAccount:StellarKeyPair? = nil, destination:StellarKeyPair, startBalance:Decimal) {
    ...
    ///
    public init(fromXDR:CreateAccountOperationXDR, sourceAccount:StellarKeyPair? = nil) {
