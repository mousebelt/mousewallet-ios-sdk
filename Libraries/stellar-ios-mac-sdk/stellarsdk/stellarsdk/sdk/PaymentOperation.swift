...
public class PaymentOperation:Operation {
    ...
    ///
    public init(sourceAccount:StellarKeyPair? = nil , destination:StellarKeyPair, asset:StellarAsset, amount:Decimal) {
    ...
    ///
    public init(fromXDR:PaymentOperationXDR, sourceAccount:StellarKeyPair? = nil) {
        self.destination = StellarKeyPair(publicKey: fromXDR.destination)
        self.asset = try! StellarAsset.fromXDR(assetXDR: fromXDR.asset)
