...
public class SetOptionsOperation:Operation {
    ...
    public let inflationDestination:StellarKeyPair?
    ...
    /// - Parameter signer: Signers StellarPublicKey. If you fill this parameter you also need to fill 'signerWeight'
    ...
    ///
    public init(sourceAccount:StellarKeyPair? = nil, inflationDestination:StellarKeyPair? = nil, clearFlags:UInt32? = nil, setFlags:UInt32? = nil, masterKeyWeight:UInt32? = nil, lowThreshold:UInt32? = nil, mediumThreshold:UInt32? = nil, highThreshold:UInt32? = nil, homeDomain:String? = nil, signer:SignerKeyXDR? = nil, signerWeight:UInt32? = nil) throws {
    ...
    ///
    public init(fromXDR:SetOptionsOperationXDR, sourceAccount:StellarKeyPair? = nil) {
        if let inflation = fromXDR.inflationDestination {
            self.inflationDestination = StellarKeyPair(publicKey: inflation)
        } else {
