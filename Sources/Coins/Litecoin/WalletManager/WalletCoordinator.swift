...
class WalletCoordinator : Trackable {
...
//                    myself.store.trigger(name: .retrySync)
    ...
    @objc private func updateTransactions() {
        ...
        DispatchQueue.walletQueue.async {
            ...
            DDLogDebug("Transactions \(txRefs)")
...
//        WalletChange.setIsRescanning(true)
    }
