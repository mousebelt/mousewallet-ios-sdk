...
public final class Crypto {
    ...
    /// - Throws: NRLWalletSDKError.failedToSign in case private key was invalid
    public static func sign(_ hash: Data, privateKey: Data) throws -> Data {
        let encrypter = EllipticCurveEncrypterSecp256k1()
        guard var signatureInInternalFormat = encrypter.sign(hash: hash, privateKey: privateKey) else { throw NRLWalletSDKError.cryptoError(.failedToSign) }
