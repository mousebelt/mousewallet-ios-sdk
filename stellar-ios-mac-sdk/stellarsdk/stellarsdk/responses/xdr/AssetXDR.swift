...
public enum AssetXDR: XDRCodable {
    ...
    public init(assetCode: String, issuer: StellarKeyPair) throws {
    ...
    public struct Alpha4XDR: XDRCodable {
        ...
        let issuer: StellarPublicKey
        
        public init(assetCode: WrappedData4, issuer: StellarPublicKey) {
    ...
    public struct Alpha12XDR: XDRCodable {
        ...
        public init(assetCode: WrappedData12, issuer: StellarPublicKey) {
            self.assetCode = assetCode
            self.issuer = issuer
        }
