...
public class AllowTrustOperation:Operation {
    ...
    public let trustor:StellarKeyPair
    ...
    ///
    public init(sourceAccount:StellarKeyPair? = nil, trustor:StellarKeyPair, assetCode:String, authorize:Bool) throws {
    ...
    ///
    public init(fromXDR:AllowTrustOperationXDR, sourceAccount:StellarKeyPair? = nil) {
        self.trustor = StellarKeyPair(publicKey: fromXDR.trustor)
