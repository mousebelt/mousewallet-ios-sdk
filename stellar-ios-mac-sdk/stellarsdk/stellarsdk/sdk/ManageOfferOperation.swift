...
public class ManageOfferOperation:Operation {
    ...
    ///
    public init(sourceAccount:StellarKeyPair? = nil, selling:StellarAsset, buying:StellarAsset, amount:Decimal, price:Price, offerId:UInt64) {
    ...
    ///
    public init(fromXDR:ManageOfferOperationXDR, sourceAccount:StellarKeyPair? = nil) {
