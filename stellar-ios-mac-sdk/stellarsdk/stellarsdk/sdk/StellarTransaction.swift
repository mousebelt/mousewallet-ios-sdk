...
public class StellarTransaction {
    ...
    /// Creates a new StellarTransaction object.
    ///
    ...
    ///
    public func sign(keyPair:StellarKeyPair, network:Network) throws {
        
        if (keyPair.privateKey == nil) {
            throw StellarSDKError.invalidArgument(message: "StellarKeyPair must contain the private key to be able to sign the transaction.")
        }
